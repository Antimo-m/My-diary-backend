...
return [
    ...
    'reset_sent' => 'If the email is registered, you will receive a link to reset the Secret Diary password.',
    'reset_throttled' => 'Too many password recovery attempts. Try again in :seconds seconds.',
];
