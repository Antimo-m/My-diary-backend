<section>
    <header class="profile-section-header">
        <span class="profile-section-icon danger"><i class="bi bi-exclamation-triangle"></i></span>
        <div>
        <h2>
            Elimina account
        </h2>
        ...
        <p>
            Questa azione elimina definitivamente account, pagine e dati collegati.
        </p>
        </div>
    </header>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta eliminato, tutte le risorse e i dati verranno rimossi definitivamente. Inserisci la password per confermare.') }}
                    </p>
                </div>
